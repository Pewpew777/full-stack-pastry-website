...
@section('content')
    <div style="background-image: url('storage/products/pexels-anete-lusina-32086078.jpg');" class="bg-cover bg-center h-screen w-screen flex flex-col justify-center items-center text-center gap-10">
